...
require_once 'includes/ddclient.php';
...
<html lang="en">
  <head>
    ...
    <!-- Librespeed CSS -->
    <link href="dist/speedtest/speedtest.css" rel="stylesheet" />
  ...
  <body id="page-top">
    ...
    <script src="dist/gridstack/gridstack-all.js"></script>

    <!-- Librespeed JavaScript -->
    <script src="dist/speedtest/speedtest.js"></script>
