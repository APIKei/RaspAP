      ...
      <h4 class="mt-3"><?php echo _("Basic settings"); ?></h4>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <?php SelectorOptions('ddclient-provider', ddnsServices(), $provider, 'cbxddns-provider', 'setddnsProviderData', null, 'custom-select custom-select-sm', 'Select a provider...'); ?>
          </div>
        </div>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            <label for="protocol"><?php echo _("Protocol"); ?></label>
              <?php SelectorOptions('ddclient-protocol', ddnsProtocols(), $protocol, 'cbxddns-protocol', 'setddnsProtocols', null, 'custom-select custom-select-sm', 'Select a protocol...'); ?>
          </div>
        </div>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <?php SelectorOptions('ddclient-method', ddnsUseMethods(), $use, 'cbxddns-methods', null, null, 'custom-select custom-select-sm', 'Select a method...'); ?>
          </div>
        </div>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="btn btn-light js-toggle-password" type="button" data-target="[name=ddclient-password]" data-toggle-with="fas fa-eye-slash"><i class="fas fa-eye mx-2"></i></button>
              </div>
            </div>
          </div>
        </div>
