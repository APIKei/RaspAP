              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="custom-control custom-switch">
                    ...
                    <input class="custom-control-input" id="chxwgkswitch" name="wgKSwitch" type="checkbox" value="1" <?php echo $checked ?> />
                    <label class="custom-control-label" for="chxwgkswitch"><?php echo _("Enable kill switch"); ?></label>
                    <i class="fas fa-question-circle text-muted" data-toggle="tooltip" data-placement="auto" title="<?php echo _("Recommended if you wish to prevent the flow of unencrypted packets through non-WireGuard interfaces."); ?>"></i>
                    <p id="wg-description">
                      <small><?php printf(_("This option adds <strong>iptables</strong> <code>PostUp</code> and <code>PreDown</code> rules for the configured AP interface (%s)."), $_SESSION['ap_interface']) ?></small>
                    </p>
                  </div>
                </div>
